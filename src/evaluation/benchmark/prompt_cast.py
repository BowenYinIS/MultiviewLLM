"""
Make predictions using LLMs without any fine-tuning.
It uses a llamacpp server.
"""
...
class PromptCast:
    ...
    def infer_single_sample(self, prompt):
        ...
        parsed_response["logprobs"] = logprobs_data
...
def main():
    ...
    configs = [
        {
            ...
            "transaction_text_type": "detail_3",  # detail_1, detail_2, summary_1, summary_2
            "sample_path": "llm_benchmark/samples_min12mo_fixed_2test.feather",
        },
        {
            "is_cot_prompt": False,
            "has_protected_attributes": False,
            "transaction_text_type": "summary_3",  # detail_1, detail_2, summary_1, summary_2
            "sample_path": "llm_benchmark/samples_min12mo_fixed_2test.feather",
        },
        {
            "is_cot_prompt": True,
    ...
    for config in configs:
        ...
        inference_pipeline = PromptCast(config)
